#!/usr/bin/env python3
"""
Simple script to create users for the Performance Review System.
Uses basic password hashing to avoid bcrypt version issues.
"""
...
def create_all_users():
    ...
    try:
        ...
        admin_user = User(
            ...
            password_hash=simple_hash_password("Admin@123"),
            is_active=True
        )
        ...
        hr_lead = User(
            ...
            position="HR Lead",
            password_hash=simple_hash_password("HR@123"),
            is_active=True
        )
        ...
        employee = User(
            ...
            password_hash=simple_hash_password("Emp@123"),
            is_active=True
        )
        ...
        mentor = User(
            ...
            password_hash=simple_hash_password("Mentor@123"),
            is_active=True
        )
        ...
        committee_member = User(
            ...
            password_hash=simple_hash_password("Committee@123"),
            is_active=True
        )
